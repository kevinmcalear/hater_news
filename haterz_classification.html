...
<p><img src="http://www.blogcdn.com/www.urlesque.com/media/2010/05/haterafrican.jpg" alt=""></p>
<h1 id="hater-news">Hater News</h1>
<p>Haterz gonna hate. But now you know who the haterz are.</p>
<h3 id="my-goal-">My Goal:</h3>
<p>Be able to look at any user from <a href="https://news.ycombinator.com/">hacker news</a> and be able to tell if they are a &quot;hater&quot; or not based on a score I give them. </p>
...
<p><em>Eventually I would love to turn this into a <a href="https://developer.chrome.com/extensions/getstarted">Chrome App</a> that will just real-time analize any user on a page when you visit hacker news and put a score right next to them so the world can see if they hate or love.</em></p>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered">
...
<div class="highlight"><pre><span class="c"># Importing my standard stuff</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Setting up my english stopwords, yo.</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># THE INITIAL &#39;STATNDARD&#39; MODEL I STARTED WITH</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Setting up our actually train and test data sets</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Since I was unhappy with aspects of my score, I added addtional features my classifier can use</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># SIDE NOTE: TfidfVectorizer sucks for this type of problem. Well, you could use it and not use idf and it does get better but not too much...</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">X_train_transform</span> <span class="o">=</span> <span class="n">vect</span><span class="o">.</span><span class="n">fit_transform</span><span class="p">(</span><span class="n">X_train</span><span class="p">)</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="n">clf</span><span class="o">.</span><span class="n">fit</span><span class="p">(</span><span class="n">X_train_transform</span><span class="p">,</span><span class="n">y_train</span><span class="p">)</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Run this cell to get a print out of each of our wrong predcitions, and how they were predicted incorrectly.</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Execute this cell to see a final scoring of our new model</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Uncomment this and execute to get a list of insults to look through for more potential patterns</span>
...
<p>Thanks <a href="https://news.ycombinator.com/">Hacker News</a> for your great <a href="https://github.com/HackerNews/API">API</a>! 
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Setting up a connection to the internetz</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Get all of a user&#39;s comments</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Testing out my function. Put in a User Name here (example: &#39;pg&#39;, &#39;vegabook&#39; or &#39;KevinMcAlear&#39;)</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Starting the transforming of my comments</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Running through my feature manipulation manually </span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Predicting the comments insult probaility</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Seeing what some predictions look like</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class="highlight"><pre><span class="c"># Finally Evaulating the hater score manually.</span>
...
<li>I want to build a Chrome app that adds in Twitter, Facebook, Reddit, etc. and overlay a post and a user &quot;hater score&quot; into the page your actually on.</li>
</ul>
</div>
</div>
</div>
